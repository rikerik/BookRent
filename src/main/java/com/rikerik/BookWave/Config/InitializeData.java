...
public class InitializeData {
    ...
    public void loadData() {
         ...
         * ResourceDatabasePopulator(false, false, "UTF-8", new
         * ClassPathResource("InitUserData.sql"));
         * 
         ...
         * encryptedPassword1, "Erik");
         * jdbcTemplate.update("UPDATE users SET password = ? WHERE username = ?",
         * encryptedPassword2, "Admin");
         * jdbcTemplate.update("UPDATE users SET password = ? WHERE username = ?",
         * encryptedPassword3, "Test");
         * 
         * //running the script which loads the books
         * 
         * resourceDatabasePopulator = new ResourceDatabasePopulator(false, false,
         * "UTF-8", new ClassPathResource("InitBookData.sql"));
         * 
         * resourceDatabasePopulator.setContinueOnError(true);
         * resourceDatabasePopulator.execute(dataSource);
         * 
